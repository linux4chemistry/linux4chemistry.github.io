...
BLOG_AUTHOR = "linux4chemistry"  # (translatable)
BLOG_TITLE = "Linux4Chemistry"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://linux4chemistry.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://linux4chemistry.github.io/"
BLOG_EMAIL = "ueb@linux4chemistry.info"
BLOG_DESCRIPTION = "Linux software for chemistry: molecular modeling, visualization, graphic, quantum mechanic, dynamic, kinetic, simulation"  # (translatable)
